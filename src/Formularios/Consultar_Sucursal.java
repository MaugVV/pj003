...
public class Consultar_Sucursal extends javax.swing.JInternalFrame {
...
public void tabla(){
   int co=0;
        ...
        List<Sucursal> listu = new ArrayList();
         ...
         String columnas[]={"N°","NOMBRE","DIRECCION","TELEFONO"};
         DefaultTableModel tm=new DefaultTableModel(null,columnas);
         tabla1.setModel(tm);
         
         for (Sucursal elem : listu) {
         co++;
             String registro []={Integer.toString(co),elem.getNombre(),elem.getDireccion(),elem.getTelefono()};
            tm.addRow(registro);
        }
          tabla1.setModel(tm);   
    ...
    private void initComponents() {
        ...
        jLabel8.setText("SUCURSALES REGISTRAAS");
