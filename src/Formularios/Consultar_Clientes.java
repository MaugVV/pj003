...
public class Consultar_Clientes extends javax.swing.JInternalFrame {
...
private TableRowSorter trsFiltro;
   ...
   int co=0;
        ...
        List<Comprador> listu = new ArrayList();
         listu = cs.ConsultarTodo();
         
         String columnas[]={"N°","CEDULA","NOMBRE","APELLIDO","DIRECCION","TELEFONO","CELULAR","EMAIL"};
         DefaultTableModel tm=new DefaultTableModel(null,columnas);
         tabla1.setModel(tm);
         
         for (Comprador elem : listu) {
         co++;
             String registro []={Integer.toString(co),elem.getCedula(),elem.getNombre(),elem.getApellido(),elem.getDireccion(),elem.getTelefono(),elem.getCelular(),elem.getEmail()};
            tm.addRow(registro);
        }
          tabla1.setModel(tm);   
